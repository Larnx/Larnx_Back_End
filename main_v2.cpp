...
void undistort_rectify(int& num_imgs, std::string calib_file, const std::string left_directory, const std::string left_filename,
	std::string right_directory, std::string right_filename, std::string extension) {
...
void disparityMapping(int& num_imgs, const std::string left_directory, const std::string left_filename,
...
void reprojectionto3D(int& num_imgs, std::string calib_file, const std::string dis_directory, const std::string dis_filename, const std::string extension, const std::string Output) {
